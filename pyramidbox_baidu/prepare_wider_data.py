...
train_list_file = os.path.join(WIDER_ROOT, 'wider_face_annotations','wider_face_train_bbx_gt.txt')
val_list_file = os.path.join(WIDER_ROOT, 'wider_face_annotations','wider_face_val_bbx_gt.txt')
...
def wider_data_file():
    ...
    for index in range(len(img_paths)):
        ...
        for box in boxes:
            ...
            data = ' {} {} {} {}'.format(box[0], box[1], box[2], box[3])
            fw.write(data)
        fw.write('\n')
    fw.close()
