        ...
        while i < len(lines):
            if '/' in lines[i]:
                ...
                for box_idx in range(num):
                    ...
                    # Part_B 数据集有错误
                    # coordinations_length = len(coordinations)
                    # print('coordinations = ', len(coordinations))
                    # if coordinations_length % 5 !=0:
                    #     print('error length = ',coordinations_length)
...
def main():
    ...
    original_file = '/home/zhex/data/yuncong/Part_B_train.txt'  # 需要被增强的训练真值txt
