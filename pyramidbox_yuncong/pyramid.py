...
class SFD(nn.Module):
    # SFD(Bottleneck, [3,4,6,3], phase , num_classes, size)
    ...
    def forward(self, x):
        ...
        #self.priors_body = Variable(torch.cat([p for p in prior_body_boxes],0))
        ...
        if self.phase == "test":
            ...
            output = (
                ...
                self.priors_head
            ) # return coordinations and condfidence tuple
        return output
